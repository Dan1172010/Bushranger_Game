...
let Gender = ""
let Version_Number = textsprite.create("Beta 0.3", 15, 13)
let Version_Code = textsprite.create("25W33A")
...
scene.setBackgroundImage(assets.image`Roombackground1`)
music.stopAllSounds()
music.setVolume(100)
...
if (story.checkLastAnswer("Do I have to?")) {
    ...
    if (story.checkLastAnswer("Daniel")) {
        ...
        game.setGameOverMessage(true, "You Caught the Boogey!")
